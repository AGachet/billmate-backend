-- This is an empty migration.-- Function: check_user_modules_access.sql
-------------------------------------------------------------------
...
END;
$$ LANGUAGE plpgsql;
-- Function: generate_reset_token.sql
------------------------------------------------------------
...
END;
$$;
-- Function: update_users_from_role.sql
-------------------------------------------------------------
...
END;
$$;
-- Trigger: update_users_from_role.sql
