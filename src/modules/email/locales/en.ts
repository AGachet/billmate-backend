export const en = {
  accountConfirmation: {
    subject: 'Confirm your BillMate account',
    title: 'Welcome to BillMate!',
    greeting: 'Hello',
    body: 'Thank you for signing up to BillMate. To activate your account, please click the button below:',
    ...
    ignore: "If you didn't create a BillMate account, you can ignore this email.",
    footer: 'This email was sent automatically. Please do not reply.'
  },
  passwordReset: {
    subject: 'Reset your BillMate password',
